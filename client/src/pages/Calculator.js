...
export default class MainCalc extends Component {
  ...
  calculateExpense() {
    ...
    let homeTot =
      homeMort + homeUtil + homeInsure + homeRepair + web + homeShop;
    console.log(homeTot);
        ...
        <Row style={{}}>
          <Col style={{ height: "" }} m={6} lg={6} xs={12}>
            <div style={{}}>
              ...
              {this.state.displayRes ? (
                <div>
                  {" "}
                  Your total income: {yourIncome}, your total expenses:{" "}
                  {yourExpenses}
                  <br />
                  budget breakdown based on your left over income:
                  <br />
                  General Savings 50% : {fifty}
                  <br />
                  Emergency Savings 30% : {thirty}
                  <br />
                  Retirement Savings 20%: {twenty}
                  <br />
                </div>
              ) : null}
          ...
          <Col style={{}}>
            <Form
              ...
              style={{ height: "", postion: "fixed" }}
              m={6}
              lg={6}
              xs={12}
              className="calc-form-style"
            >
