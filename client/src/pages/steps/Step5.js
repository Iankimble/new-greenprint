  ...
  return (
    <div style={{ fontFamily: "Gelasio" }}>
      ...
      <label style={{ fontSize: "15px" }}>
        {" "}
        How much do you pay for entertainment and leisure ?{" "}
      </label>
      <br />
      <input
        id="entertainment"
      ...
      <label style={{ fontSize: "15px" }}>
        {" "}
        How much do you pay medical expenses ?{" "}
      </label>
      <br />
      <input
        id="medical"
      ...
      <label style={{ fontSize: "15px" }}>
        {" "}
        How much do you pay for any other expenses?{" "}
      </label>
      <br />
      <input
        id="other"
      ...
      ></input>
      <br />
      Click 'calculate to get expense breakdown'
      <br />
      <br />
      <button
        style={{
